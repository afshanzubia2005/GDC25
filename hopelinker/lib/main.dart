...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(home: StartupSplashScreen());
  }
}
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            top:
                -circleDiameter *
                0.35, // Move it up so it covers the top and still appears lower
            child: Container(
              ...
              decoration: const BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [Color(0xFF1897B9), Color(0xFF293C72)],
                ),
              ),
            ),
          ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: const Color(
                  0xFFF5F5F5,
                ).withValues(alpha: 0.3), // Bright grey, semi-transparent
                boxShadow: [
                  BoxShadow(
              ...
              child: Image.asset('assets/logomini.png', height: 50, width: 50),
            ),
          ),
...
class _StartupSplashScreenState extends State<StartupSplashScreen>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 7), () {
      if (mounted) {
        // Use mounted instead of context.mounted
            ...
            child: Center(
              child: FadeTransition(
                ...
                child: Column(
                  ...
                  children: [
                    Image(image: AssetImage('assets/logo.png'), height: 268),
                  ],
                ),
              ),
            ),
